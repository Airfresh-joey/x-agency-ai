...
const footerLinks = {
  ...
  industries: [
    ...
    { name: 'Manufacturing & Logistics', href: '/industries/manufacturing' },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              Your AI Strategy & Implementation Partner
            </p>
          ...
          {/* Industries */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Industries</h3>
            <ul className="mt-4 space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            &copy; {new Date().getFullYear()} X Agency AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
